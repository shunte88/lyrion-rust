...
-- Add performance indexes for large collections (200k+ tracks)
...
CREATE INDEX IF NOT EXISTS idx_tracks_titlesearch ON tracks(titlesearch);
CREATE INDEX IF NOT EXISTS idx_tracks_audio ON tracks(audio) WHERE audio = 1;

-- Albums table indexes
CREATE INDEX IF NOT EXISTS idx_albums_titlesearch ON albums(titlesearch);
CREATE INDEX IF NOT EXISTS idx_albums_year ON albums(year);

-- Contributors table indexes
CREATE INDEX IF NOT EXISTS idx_contributors_namesearch ON contributors(namesearch);

-- Genres table indexes
CREATE INDEX IF NOT EXISTS idx_genres_namesearch ON genres(namesearch);

-- Junction table indexes
CREATE INDEX IF NOT EXISTS idx_contributor_track_track ON contributor_track(track);
CREATE INDEX IF NOT EXISTS idx_contributor_track_contributor ON contributor_track(contributor);
CREATE INDEX IF NOT EXISTS idx_contributor_track_role ON contributor_track(role);
CREATE INDEX IF NOT EXISTS idx_genre_track_track ON genre_track(track);
CREATE INDEX IF NOT EXISTS idx_genre_track_genre ON genre_track(genre);

-- Composite indexes for common queries
CREATE INDEX IF NOT EXISTS idx_tracks_audio_titlesort ON tracks(audio, titlesort) WHERE audio = 1;
CREATE INDEX IF NOT EXISTS idx_contributor_track_composite ON contributor_track(track, role, contributor);
